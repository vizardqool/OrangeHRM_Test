...
function requireTapErrors () {
	...
	(function (exports) {
		 ...
		 */
		exports.TAP_TARGET = 'Cypress session';
		/**
		 ...
		 */
		const UNREACHABLE = {
		    description: `Could not reach the ${exports.TAP_TARGET}.`,
		...
		const COMMAND_FAILED = {
		    description: `The ${exports.TAP_TARGET} failed while running the command.`,
		    solution: `Check the ${exports.TAP_TARGET} with \`cypress tap status\`, then try again.`,
		};
		/**
		...
		exports.TAP_ERROR_COPY = {
		     ...
		     */
		    SESSION_NOT_FOUND: {
		        description: `No ${exports.TAP_TARGET} matched the provided session id.`,
		        solution: `Run \`cypress tap sessions\` to list the ${exports.TAP_TARGET}s you can tap into.`,
		    },
		    ...
		    NO_BROWSER_ATTACHED: {
		        description: `The ${exports.TAP_TARGET} is running, but no test browser is open.`,
		    ...
		    UNSUPPORTED_BROWSER: {
		        description: `The ${exports.TAP_TARGET} is running an unsupported browser.`,
		    ...
		    RENDERER_UNRESPONSIVE: {
		        description: `The ${exports.TAP_TARGET} is reachable, but the page running it is not responding.`,
		    ...
		    CLI_OUTDATED: {
		        description: `The targeted ${exports.TAP_TARGET} is newer than this CLI.`,
		        solution: `Update the CLI with ${UPDATE_COMMAND}, then try again.`,
		    },
		    /** Raised when the handshake reported an older schema version, or the session does not serve the tap GraphQL route. */
		    SESSION_OUTDATED: {
		        description: `The targeted ${exports.TAP_TARGET} is older than this CLI.`,
		    ...
		    SPEC_START_FAILED: {
		        description: `The ${exports.TAP_TARGET} could not start the spec.`,
		        solution: `Check the ${exports.TAP_TARGET} with \`cypress tap status\`, then try again.`,
		    },
		    /** Raised when the given path matches no spec the session can run. */
		    SPEC_NOT_FOUND: {
		        description: `The ${exports.TAP_TARGET} has no spec matching that path.`,
		        solution: `\`cypress tap specs\` lists the specs the ${exports.TAP_TARGET} can run. If the spec exists but is not listed, widen \`specPattern\` in the Cypress configuration.`,
		    },
		    /** Raised when the session is running with no project open. */
		    NO_PROJECT: {
		        description: `The ${exports.TAP_TARGET} has no project open.`,
		    ...
		    NO_AUT: {
		        description: `Failed to determine the app under test in the ${exports.TAP_TARGET}.`,
		...
		// cannot be read.
		const FALLBACK = exports.TAP_ERROR_COPY.PROTOCOL_MISMATCH;
		/**
		...
		const tapErrorCopy = (code) => {
		    if (typeof code !== 'string' || !Object.prototype.hasOwnProperty.call(exports.TAP_ERROR_COPY, code)) {
		        return FALLBACK;
		    }
		    return exports.TAP_ERROR_COPY[code];
		};
		exports.tapErrorCopy = tapErrorCopy;
		/**
		...
		exports.InvalidValueTapError = InvalidValueTapError;
		/**
		...
		exports.SessionNotFoundTapError = SessionNotFoundTapError;
		class TestNotFoundTapError extends NotFoundTapError {
		    constructor(value) {
		        super('TEST_NOT_FOUND', '--test-id', value);
		    }
		}
		exports.TestNotFoundTapError = TestNotFoundTapError;
		/**
		...
		exports.MissingCompanionOptionTapError = MissingCompanionOptionTapError;
		/**
		...
		exports.UnknownCommandTapError = UnknownCommandTapError;
		...
		exports.UnknownOptionTapError = UnknownOptionTapError;
		/**
		...
		exports.MissingArgumentsTapError = MissingArgumentsTapError;
		...
		exports.MissingOptionTapError = MissingOptionTapError;
		/**
		...
		class VersionSkewTapError extends TapError {
		    constructor({ sessionSchema, cliSchema, sessionCypress, cliCypress }) {
		        super(sessionSchema > cliSchema ? 'CLI_OUTDATED' : 'SESSION_OUTDATED', {
		            detail: `The ${exports.TAP_TARGET} is running Cypress v${sessionCypress}; this CLI is v${cliCypress}.`,
		            message: `the ${exports.TAP_TARGET} speaks tap schema v${sessionSchema}; this CLI speaks v${cliSchema}.`,
		        });
		    }
		}
		exports.VersionSkewTapError = VersionSkewTapError;
		/**
		...
		exports.SpecInProgressTapError = SpecInProgressTapError;
		/**
		...
		exports.UnknownTapError = UnknownTapError;
...
function requireTapContract () {
	...
	(function (exports) {
		...
		var __exportStar = (tapContract && tapContract.__exportStar) || function(m, exports) {
		    for (var p in m) if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports, p)) __createBinding(exports, m, p);
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.KNOWN_COMMANDS = exports.TAP_NATIVE_COMMANDS = exports.buildTapSchema = exports.TAP_COMMANDS = exports.TAP_EXEC_METHOD = exports.TAP_SCHEMA_METHOD = exports.TAP_BINDING_GLOBAL = exports.TAP_SCHEMA_VERSION = void 0;
		exports.TAP_SCHEMA_VERSION = 1;
		exports.TAP_BINDING_GLOBAL = '__CYPRESS_TAP_BINDING__';
		exports.TAP_SCHEMA_METHOD = 'getSchema';
		exports.TAP_EXEC_METHOD = 'exec';
...
dom/aria/inspect commands can read it. Pass --clear to release.`,
		...
		const buildTapSchema = (cypressVersion) => {
		    const commands = exports.TAP_COMMANDS.map((command) => {
		        return {
		            name: command.name,
		    ...
		    return {
		        schemaVersion: exports.TAP_SCHEMA_VERSION,
		        cypressVersion,
		        commands,
		    };
		};
		exports.buildTapSchema = buildTapSchema;
		const runMeta = {
		    name: 'run',
...
${AMBIGUOUS_SELECTOR_HELP}`,
		...
		const allTapCommands = [...exports.TAP_NATIVE_COMMANDS, ...exports.TAP_COMMANDS];
		/** Every command name this CLI ships, whether it dispatches to the session or handles it itself. */
		exports.KNOWN_COMMANDS = new Set(allTapCommands.map(({ name }) => name));
		...
		__exportStar(requireTapErrors(), exports);
		...
		__exportStar(requireReporter(), exports);
		__exportStar(requireCommand(), exports);
		__exportStar(requirePinned(), exports);
		__exportStar(requirePin(), exports);
		__exportStar(requireResolveSelector(), exports);
...
function requireDist () {
	...
	(function (exports) {
		...
		exports.LEGACY_TAP_GRAPHQL_PATH = '/__cypress/graphql';
		exports.TAP_SUPPORTED_BROWSER_FAMILY = 'chromium';
		...
		const isTapSupportedBrowser = (browserFamily) => {
		    return browserFamily === null || browserFamily === exports.TAP_SUPPORTED_BROWSER_FAMILY;
		};
		exports.isTapSupportedBrowser = isTapSupportedBrowser;
		const recordFileName = (pid) => {
		    return `${pid}${RECORD_EXTENSION}`;
		};
		exports.recordFileName = recordFileName;
		...
		exports.parseRecordPid = parseRecordPid;
		const cypressSessionsDir = (cacheRoot) => {
		    return path_1.default.join(cacheRoot, exports.SESSIONS_DIRNAME);
		};
		exports.cypressSessionsDir = cypressSessionsDir;
		const recordPath = (cacheRoot, pid) => {
		    return path_1.default.join((0, exports.cypressSessionsDir)(cacheRoot), (0, exports.recordFileName)(pid));
		};
		exports.recordPath = recordPath;
		const sessionProbePath = (sessionId) => {
		    return `${exports.SESSIONS_ROUTE_PREFIX}${sessionId}`;
		};
		exports.sessionProbePath = sessionProbePath;
		const tapGraphqlPath = (operationName) => {
		    return `${exports.TAP_GRAPHQL_ROUTE_PREFIX}${operationName}`;
		};
		exports.tapGraphqlPath = tapGraphqlPath;
		...
		const isCompatibleRecord = (record) => {
		    return Boolean(record)
		        ...
		        && record.schemaVersion >= exports.MIN_SCHEMA_VERSION
		...
		exports.isCompatibleRecord = isCompatibleRecord;
...
const debug$8 = Debug('cypress:cli:cypress-sessions');
...
const cdpEndpointReachable = (cdpBrowserWsUrl, timeoutMs) => xvfb.__awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        debug$8('could not derive a CDP version url from %s: %o', cdpBrowserWsUrl, err);
        return false;
    }
    try {
        ...
        debug$8('CDP endpoint unreachable at %s: %o', versionUrl, err);
        return false;
    }
});
const verifySessionRecord = (record_1, ...args_1) => xvfb.__awaiter(void 0, [record_1, ...args_1], void 0, function* (record, timeoutMs = DEFAULT_PROBE_TIMEOUT_MS) {
    ...
    try {
        ...
        debug$8('liveness probe failed for pid %d on port %d: %o', record.pid, record.serverPort, err);
        return null;
    }
});

const debug$7 = Debug('cypress:cli:cypress-sessions');
...
const readCompatibleRecord = (filePath) => xvfb.__awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        debug$7('could not read cypress sessions record %s: %o', filePath, err);
        return null;
    }
    if (!distExports.isCompatibleRecord(record)) {
        debug$7('incompatible cypress sessions record %s', filePath);
        return null;
    }
    return record;
});
...
const reapIfDead = (file) => xvfb.__awaiter(void 0, void 0, void 0, function* () {
    ...
    yield fs.remove(path).catch((err) => {
        debug$7('failed to reap dead cypress sessions record %s: %o', path, err);
    });
    return true;
});
/**
...
const pruneDeadSessionRecords = () => xvfb.__awaiter(void 0, void 0, void 0, function* () {
    ...
    debug$7('pruned %d dead cypress sessions record(s)', removed);
    return removed;
});
...
const processOpenOptions = (options = {}) => {
    ...
    debug$6('opening from options %j', options);
    debug$6('command line arguments %j', args);
    return args;
};
const start$3 = (...args_1) => xvfb.__awaiter(void 0, [...args_1], void 0, function* (options = {}) {
    function open() {
        try {
...
const debug$5 = Debug('cypress:cli:run');
/**
...
const processRunOptions = (options = {}) => {
    debug$5('processing run options %o', options);
    ...
    if (options.key == null) {
        debug$5('--key is not set, looking up environment variable CYPRESS_RECORD_KEY');
        ...
        return xvfb.__awaiter(this, arguments, void 0, function* (options = {}) {
            ...
            function run() {
                try {
                    ...
                    debug$5('run to spawn.start args %j', args);
                    return spawn.start$1(args, {
                        dev: options.dev,
                    });
                }
...
const getCA = () => xvfb.__awaiter(void 0, void 0, void 0, function* () {
    if (process.env.npm_config_cafile) {
        try {
            ...
            debug$4('error reading ca file', error);
            return;
        }
    }
...
const prepend = (arch, urlPath, version) => {
    ...
    if ((platform === 'win32') && (arch === 'arm64')) {
        ...
        arch = 'x64';
        debug$4(`overriding to download ${platform}-${arch} instead`);
    }
    return pathTemplate
        ? (pathTemplate
...
const getUrl = (arch, version) => {
    if (_.isString(version) && version.match(/^https?:\/\/.*$/)) {
        debug$4('version is already an url', version);
        return version;
    }
...
const verifyDownloadedFile = (filename, expectedSize, expectedChecksum) => xvfb.__awaiter(void 0, void 0, void 0, function* () {
    if (expectedSize && expectedChecksum) {
        debug$4('verifying checksum and file size');
        return Bluebird.join(xvfb.util.getFileChecksum(filename), xvfb.util.getFileSize(filename), (checksum, filesize) => {
            if (checksum === expectedChecksum && filesize === expectedSize) {
                debug$4('downloaded file has the expected checksum and size ✅');
                return;
            }
            debug$4('raising error: checksum or file size mismatch');
    ...
    if (expectedChecksum) {
        debug$4('only checking expected file checksum %d', expectedChecksum);
        const checksum = yield xvfb.util.getFileChecksum(filename);
        if (checksum === expectedChecksum) {
            debug$4('downloaded file has the expected checksum ✅');
            return;
        }
        debug$4('raising error: file checksum mismatch');
        const text = commonTags.stripIndent `
      Corrupted download
    ...
    if (expectedSize) {
        ...
        debug$4('only checking expected file size %d', expectedSize);
        const filesize = yield xvfb.util.getFileSize(filename);
        if (filesize === expectedSize) {
            debug$4('downloaded file has the expected size ✅');
            return;
        }
        debug$4('raising error: file size mismatch');
        const text = commonTags.stripIndent `
        Corrupted download
    ...
    debug$4('downloaded file lacks checksum or size to verify');
    return;
});
...
const downloadFromUrl = ({ url, downloadDestination, progress, ca, version, redirectTTL = defaultMaxRedirects }) => {
    ...
    return new Bluebird((resolve, reject) => {
        ...
        debug$4('Downloading package', {
            url,
            proxy,
            downloadDestination,
        });
        if (ca) {
            debug$4('using custom CA details from npm config');
        }
        ...
        requestProgress(req, {
            ...
            if (expectedChecksum) {
                debug$4('expected checksum %s', expectedChecksum);
            }
            if (expectedSize) {
                // convert from string (all Amazon custom headers are strings)
                expectedSize = Number(expectedSize);
                debug$4('expected file size %d', expectedSize);
            }
            ...
            if (/^3/.test(response.statusCode)) {
                ...
                debug$4('redirect version:', redirectVersion);
                debug$4('redirect url:', redirectUrl);
                ...
                debug$4('response code %d', response.statusCode);
 ...
 */
const start$2 = (opts) => xvfb.__awaiter(void 0, void 0, void 0, function* () {
    ...
    debug$4('needed Cypress version: %s', version);
    debug$4('source url %s', versionUrl);
    debug$4(`downloading cypress.zip to "${downloadDestination}"`);
    try {
...
const debug$3 = Debug('cypress:cli:unzip');
const unzipTools = {
    extractWithYauzl,
};
// expose this function for simple testing
const unzip = (_a) => xvfb.__awaiter(void 0, [_a], void 0, function* ({ zipFilePath, installDir, progress }) {
    debug$3('unzipping from %s', zipFilePath);
    debug$3('into', installDir);
    if (!zipFilePath) {
    ...
    yield new Promise((resolve, reject) => {
        ...
        return yauzl.open(zipFilePath, { lazyEntries: true }, (err, zipFile) => {
            ...
            if (err) {
                debug$3('error using yauzl %s', err.message);
                return reject(err);
            }
            const total = zipFile.entryCount;
            debug$3('zipFile entries count', total);
...
const start$1 = (_a) => xvfb.__awaiter(void 0, [_a], void 0, function* ({ zipFilePath, installDir, progress }) {
    ...
    try {
        ...
        if (installDirExists) {
            debug$3('removing existing unzipped binary', installDir);
...
const debug$2 = Debug('cypress:cli:install');
function _getBinaryUrlFromBuildInfo(version, arch, { commitSha, commitBranch }) {
    const platform = os.platform();
    if ((platform === 'win32') && (arch === 'arm64')) {
        debug$2(`detected platform ${platform} architecture ${arch} combination`);
        arch = 'x64';
        debug$2(`overriding to download ${platform}-${arch} pre-release binary instead`);
    }
...
function getEnvVarVersion() {
    ...
    debug$2('using environment variable CYPRESS_INSTALL_BINARY "%s"', envVarVersion);
    return envVarVersion;
}
const start = (...args_1) => xvfb.__awaiter(void 0, [...args_1], void 0, function* (options = {}) {
    debug$2('installing with options %j', options);
    const envVarVersion = getEnvVarVersion();
    if (envVarVersion === '0') {
        debug$2('environment variable CYPRESS_INSTALL_BINARY = 0, skipping install');
        xvfb.loggerModule.log(commonTags.stripIndent `
    ...
    debug$2('version in package.json is %s, version to install is %s', pkgVersion, versionToInstall);
    ...
    const shouldInstall = () => {
        if (!binaryVersion) {
            debug$2('no binary installed under cli version');
            return true;
        }
        xvfb.loggerModule.log();
        xvfb.loggerModule.log(commonTags.stripIndent `
      ...
      `);
        xvfb.loggerModule.log();
        if (options.force) {
            debug$2('performing force install over existing binary');
            return true;
        }
    ...
    if (!shouldInstall()) {
        return debug$2('Not downloading or installing binary');
    }
    if (envVarVersion) {
        xvfb.loggerModule.log(chalk.yellow(commonTags.stripIndent `
    ...
    const getLocalFilePath = () => xvfb.__awaiter(void 0, void 0, void 0, function* () {
        ...
        debug$2('checking local file', possibleFile, 'cwd', process.cwd());
    ...
    if (options.force) {
        debug$2('Cypress already installed at', installDir);
        debug$2('but the installation was forced');
    }
...
function downloadArchive(version, downloadDestination) {
    ...
    return {
        ...
        task: (ctx, task) => xvfb.__awaiter(this, void 0, void 0, function* () {
            ...
            debug$2(`finished downloading file: ${downloadDestination}`);
...
function installFromLocal(pathToLocalFile, installDir) {
    ...
    debug$2('found local file at', zipFilePath);
    debug$2('skipping download');
    return [
...
function installFromRemote(version, installDir) {
    ...
    debug$2('preparing to download and unzip version ', version, 'to path', installDir);
    return [
...
function cleanup(archiveLocation, installDir) {
    return {
        ...
        task: (ctx, task) => xvfb.__awaiter(this, void 0, void 0, function* () {
            debug$2('removing zip file %s', archiveLocation);
            yield fs.remove(archiveLocation);
            debug$2('finished installation in', installDir);
