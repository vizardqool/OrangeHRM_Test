...
function requireDist () {
	...
	(function (exports) {
		...
		exports.isAgent = exports.detectAgent = void 0;
		...
		const isAgent = (env = process.env) => {
		    return !!(0, exports.detectAgent)(env);
		};
...
const throwForUnservedPaths = (session, operationName) => xvfb.__awaiter(void 0, void 0, void 0, function* () {
    const live = yield cli.verifySessionRecord(session);
    if (live === null) {
...
const querySessionGraphql = (session_1, operation_1, ...args_1) => xvfb.__awaiter(void 0, [session_1, operation_1, ...args_1], void 0, function* (session, operation, timeoutMs = DEFAULT_QUERY_TIMEOUT_MS) {
    ...
    let response;
    try {
        response = yield post(cli.distExports.tapGraphqlPath(operationName));
        ...
        if (isUnservedPath(response)) {
            debug$2('graphql request %s to pid %d went unserved; retrying the legacy path', operationName, session.pid);
            response = yield post(`${cli.distExports.LEGACY_TAP_GRAPHQL_PATH}/${operationName}`);
        }
    }
    catch (err) {
    ...
    if (isUnservedPath(response)) {
        return yield throwForUnservedPaths(session, operationName);
    }
