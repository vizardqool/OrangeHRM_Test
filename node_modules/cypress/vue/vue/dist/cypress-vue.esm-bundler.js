...
import { nextTick, defineComponent, computed, h, shallowReactive, reactive, ref, createApp, transformVNodeArgs, setDevtoolsHook, isRef, TransitionGroup, Transition, BaseTransition } from 'vue';
...
mount: VTUmount} = _VueTestUtils, vueTestUtils = __rest(_VueTestUtils, ["mount", "shallowMount"]);
const VueTestUtils = vueTestUtils;
